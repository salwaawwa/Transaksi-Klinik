...
<head>
  ...
  <title>Klinik Spesialis UROLOGI - @yield('title')</title>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="/assets/sbadmin/vendor/datatables/dataTables.bootstrap4.min.css">
</head>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-text mx-3">Klinik Spesialis UROLOGI</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="dataTindakan">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <footer class="sticky-footer bg-white mt-4">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Klinik Spesialis UROLOGI 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
